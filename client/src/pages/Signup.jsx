    ...
    <div className="auth-page bg-grid">
      ...
      >
        ...
        <div className="auth-card__header">
          <Link to="/" className="auth-card__logo">
            <svg width="32" height="32" viewBox="0 0 28 28" fill="none">
              <rect width="28" height="28" rx="8" fill="url(#auth-grad2)" />
              <path d="M8 14L12 18L20 10" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <defs>
                <linearGradient id="auth-grad2" x1="0" y1="0" x2="28" y2="28">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="auth-form__group">
            ...
            <div className="auth-form__input-wrapper">
              <FiUser className="auth-form__icon" size={18} />
              <input
                id="signup-name"
                type="text"
                name="name"
        ...
        <p className="auth-card__footer">
          ...
          <Link to="/login" className="auth-card__footer-link">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
